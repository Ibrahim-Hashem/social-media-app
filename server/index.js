...
/* ROUTES WITH FILES*/
app.post('/auth/register', upload.single('image'), register); // register route with file
...
mongoose.connect(process.env.MONGO_URL, { useNewUrlParser: true, useUnifiedTopology: true }).then(app.listen(PORT,()=>{
